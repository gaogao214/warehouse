...
void inventory::tableWidgetFlush(QString name,int num)
{
    qDebug()<<"tableWidgetFlush name"<<name<<" num:"<<num<<"\n";

    // m_psaleVector.clear();
    // m_pstrorageVector.clear();

    m_pstrorageInventory.name = name;
    m_pstrorageInventory.num = num;
    m_pstrorageVector.push_back(m_pstrorageInventory);
